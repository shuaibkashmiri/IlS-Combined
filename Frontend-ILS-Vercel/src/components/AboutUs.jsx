          ...
          <div className="grid gap-8">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  pedagogy. We're committed to making quality education
            ...
            <div className="text-center mt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  { image: "/hero.jpg", title: "Interactive Learning" },
                  { image: "/image1.jpg", title: "Expert Instruction" },
                  { image: "/image2.jpg", title: "Flexible Learning" },
                ].map((item, index) => (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <h3 className="text-xl font-semibold mb-2 text-[#164758]">
                      {item.title}
                    </h3>
                    <p className="text-sm text-[#164758] text-center max-w-xs">
                      Engaging content, expert guidance, and flexible access to
