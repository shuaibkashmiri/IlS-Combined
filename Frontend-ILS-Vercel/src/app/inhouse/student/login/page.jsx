...
const OfflineStudentLogin = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    dispatch(offlineStudentLogin(formData));
  };
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className="appearance-none block w-full pl-10 px-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm transition duration-150 ease-in-out"
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                >
                  {showPassword ? (
                    <svg
                      className="h-5 w-5 text-gray-400 hover:text-gray-500 transition duration-150 ease-in-out"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
...
export default OfflineStudentLogin;
