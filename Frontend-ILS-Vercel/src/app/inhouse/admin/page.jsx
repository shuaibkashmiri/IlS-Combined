...
const InhouseAdminDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* Sidebar */}
      <aside className="w-72 bg-white border-r border-gray-200 flex flex-col py-8 px-4 min-h-screen fixed shadow-lg">
        <div className="mb-10 flex flex-col items-center">
          <img
            src="/logo.png"
            alt="ILS Logo"
            className="h-14 mb-4 transform hover:scale-105 transition-transform"
          />
              ...
              {activeTab === "dashboard" && (
                <>
                  <header className="mb-10">
                    <h1 className="text-4xl font-bold text-[#164758] mb-3">
                      Welcome back!
                    </h1>
                  ...
                  {/* Filters */}
                  <div className="mb-8 flex flex-wrap gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                  ...
                  <section>
                    <div className="flex items-center gap-3 mb-6">
                      <FaUsers className="h-7 w-7 text-[#00965f]" />
                      <h3 className="text-2xl font-bold text-gray-800">
                        Students Enrolled
                      </h3>
                    </div>
